...
return {
   ...
   fields = {
      ...
      { x = 115, y =  24, min =   0, max =   1, param =  43, type = "bool",    to = SMLSIZE, valuetext = { [0] = "Deaktiviert", "Aktiviert" } },
      -- Qualitaet
      --{ x = 115, y =  32, min =   0, max = 100, param = ???, type = "readonly", to = SMLSIZE },		-- TODO
      -- Wert
      { x = 140, y =  40, min = -30, max =  30, param =  44, type = "int32_t", to = SMLSIZE },
      { x = 165, y =  40, min = -30, max =  30, param =  45, type = "int32_t", to = SMLSIZE },
      -- Optimierer aktivieren
      { x = 115, y =  56, min =   0, max =   1, param =  47, type = "bool",    to = SMLSIZE, valuetext = { [0] = "Deaktiviert", "Aktiviert" } },
   },
}