...
return {
   ...
   fields = {
      ...
      { x = 160, y =   8, min =   0, max =   1, param = 168, type = "bool",    to = SMLSIZE, valuetext = { [0] = "Deaktiviert", "Aktiviert" } },
      -- Cyclic Ring aktivieren
      { x = 160, y =  24, min =   0, max =   1, param = 126, type = "bool",    to = SMLSIZE, valuetext = { [0] = "Aus", "An" } },
