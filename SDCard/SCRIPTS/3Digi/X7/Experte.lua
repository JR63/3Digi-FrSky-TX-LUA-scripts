...
return {
   ...
   text_en = {
      ...
      { t = "R.u.c. stat.",				x =   3, y =  48, to = SMLSIZE },
      { t = "R.u.c. dyna.",				x =   3, y =  56, to = SMLSIZE },
   },
   value_set = 2,
   param_check = 48462,
   fields = {
      ...
      { x =  55, y =  32, min =   0, max =   1, param = 135, type = "bool",    to = SMLSIZE, valuetext = { [0] = "Einf", "Erwe" }, valuetext_en = { [0] = "Simp", "Exte" } },
      ...
      { x =  80, y =  32, min =   0, max =   1, param = 147, type = "bool",    to = SMLSIZE, valuetext = { [0] = "Einf", "Erwe" }, valuetext_en = { [0] = "Simp", "Exte" } },
