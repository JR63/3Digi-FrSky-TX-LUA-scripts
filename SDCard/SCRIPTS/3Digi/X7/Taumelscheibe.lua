...
return {
   ...
   text_en = {
      { t = "Act. piro. opt.",				x =   3, y =   8, to = SMLSIZE },
   ...
   fields = {
      ...
      { x =  76, y =   8, min =   0, max =   1, param = 168, type = "bool",    to = SMLSIZE, valuetext = { [0] = "Deaktiviert", "Aktiviert" }, valuetext_en = { [0] = "Deactivated", "Activated" } },
      -- Cyclic Ring aktivieren
      { x = 110, y =  24, min =   0, max =   1, param = 126, type = "bool",    to = SMLSIZE, valuetext = { [0] = "Aus", "An" }, valuetext_en = { [0] = "Off", "On" } },
