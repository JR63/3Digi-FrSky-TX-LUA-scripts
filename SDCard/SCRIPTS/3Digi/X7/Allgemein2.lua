...
return {
   ...
   text_en = {
      ...
      { t = "Act. optim.",				x =   6, y =  24, to = SMLSIZE },
      { t = "Quality",					x =   6, y =  32, to = SMLSIZE },
      { t = "Value",					x =   6, y =  40, to = SMLSIZE },
      { t = "Act. optim.",				x =   6, y =  56, to = SMLSIZE },
   },
   ...
   fields = {
      ...
      { x =  59, y =  24, min =   0, max =   1, param =  43, type = "bool",    to = SMLSIZE, valuetext = { [0] = "Deaktiviert", "Aktiviert" }, valuetext_en = { [0] = "Deactivated", "Activated" } },
      -- Qualitaet
      { x =  59, y =  32, min =   0, max = 20000, param =  46, type = "bar",   to = SMLSIZE, ro = 1 },
      -- Wert
      { x =  59, y =  40, min = -30, max =  30, param =  44, type = "int32_t", to = SMLSIZE },
      { x =  82, y =  40, min = -30, max =  30, param =  45, type = "int32_t", to = SMLSIZE },
      -- Optimierer aktivieren
      { x =  59, y =  56, min =   0, max =   1, param =  47, type = "bool",    to = SMLSIZE, valuetext = { [0] = "Deaktiviert", "Aktiviert" }, valuetext_en = { [0] = "Deactivated", "Activated" } },
   },
}