...
return {
   ...
   fields = {
      ...
      { x = 110, y = 185, min =   0, max = 125, param = 167, type = "uint8_t", to = MIDSIZE },
      -- Drehmomentausgleich Von Roll
      { x = 260, y = 185, min =   0, max = 125, param = 165, type = "uint8_t", to = MIDSIZE },
      -- Drehmomentausgleich Von Nick
      { x = 410, y = 185, min =   0, max = 125, param = 166, type = "uint8_t", to = MIDSIZE },
   },
}